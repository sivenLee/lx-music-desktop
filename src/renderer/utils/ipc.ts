...
export const localMusicGetState = async(): Promise<LX.LocalMusic.LocalMusicViewState> => {
  return rendererInvoke<LX.LocalMusic.LocalMusicViewState>(LOCAL_MUSIC_EVENT_NAME.get_state)
}
...
export const localMusicScanDirectory = async(params: {
  dirPath: string
  ...
  return rendererInvoke<{
    ...
    directoryConfig: LX.LocalMusic.LocalMusicDirectoryConfig
  }>(LOCAL_MUSIC_EVENT_NAME.scan_directory, params)
}

export const localMusicSaveDirectoryConfig = async(params: {
  dirPath: string
  ...
  return rendererInvoke<{
    dirPath: string
    config: LX.LocalMusic.LocalMusicDirectoryConfig
  }, LX.LocalMusic.LocalMusicDirectoryConfig>(LOCAL_MUSIC_EVENT_NAME.save_directory_config, params)
}
...
export const localMusicCreatePlaylist = async(params: {
  ...
  return rendererInvoke<{
    dirPath: string
    name: string
  }, string>(LOCAL_MUSIC_EVENT_NAME.create_playlist, params)
}

export const localMusicRenamePlaylist = async(params: {
  playlistPath: string
  name: string
}): Promise<string> => {
  return rendererInvoke<{
    playlistPath: string
    name: string
  }, string>(LOCAL_MUSIC_EVENT_NAME.rename_playlist, params)
}
